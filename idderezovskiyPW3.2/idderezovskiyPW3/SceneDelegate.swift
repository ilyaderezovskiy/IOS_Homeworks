...
//  idderezovskiyPW3
//
//  Created by Ilya Derezovskiy on 10.10.2021.
//
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        stackVC.loadViewIfNeeded()
        tableVC.loadViewIfNeeded()
        collectionVC.loadViewIfNeeded()
        
        AlarmMenadger.configureScene(collectionVC: collectionVC, tableVC: tableVC, stackVC: stackVC)
        
        let navControllers = [
            UINavigationController(rootViewController: stackVC),
